...
[
  ...
  },
  {
    ...
    "help": "You must provide the current cart state for this to work.",
    "valueValidators": [
      {
        "type": "NON_EMPTY"
      }
  ...
  {
    "type": "TEXT",
    "name": "purchaseProductsArray",
    "displayName": "Order Products Array",
    "simpleValueType": true,
    "enablingConditions": [
      {
        "paramName": "ecommerceAction",
    ...
    "help": "By default, this tag will look into ecommerce.items.",
  ...
  },
  {
    ...
    "displayName": "Override items array keys",
...
if(isMatomoSet()) {
  ...
  if(data.ecommerceAction == "cartUpdate") {
    let total = 0;
    let products = data.cartProductsArray;
     ...
     products.forEach(function(product){
      ...
      total += product[data.productQuantityKey || "quantity"] * product[data.productPriceKey || "price"];
    });
  ...
  if(data.ecommerceAction == "order") {
    ...
    let products = data.purchaseProductsArray || ecommerce.items;
